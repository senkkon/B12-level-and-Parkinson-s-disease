## Linkage disequilibrium score regression (LDSR) between B12 and PD risk/age at onset
...
#!/bin/bash
mkdir -p Munged
mkdir -p B12_PD_results

# Create munge sumstats for LDSR
for FILE in ./summary_stats/*ldsc.tsv; do
    ...
    ../ldsc.py \
        ...
        --out ./B12_PD_results/PD_$BASENAME \
        --rg ./PD.sumstats.gz,./Munged/$BASENAME.sumstats.gz \
